 ...
 */
@JsonDeserialize(builder = ScrubberRestResponse.Builder.class)
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ScrubberRestResponse<T> {
	...
	private ScrubberRestResponse(Builder<T> builder) {
	...
	public static class Builder<T> {
		...
		public ScrubberRestResponse<T> build() {
			return new ScrubberRestResponse<T>(this);
		}
	}
